      ...
      <q-banner>
        <div class="row fit justify-center q-mb-lg">
          <div class="col-6 col-md-4 q-mx-md">
            ...
            <p class="gucci1 text-h5">officia reprehenderit iusto optio suscipit, veritatis voluptatum delectus minus illum deserunt laboriosam praesentium.</p>
          </div>

          <div
            class="col-6 col-md-4 col-sm-6 col-xs-12 q-mx-md"
