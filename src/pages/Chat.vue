...
export default {
  ...
  methods: {
    ...
    //função para rolar a página quando um noava mensagem chega
    scrollToBottom () {
  ...
  // ao sair da página chama uma action do store
  // par aapgar a mensagens do store
  destroyed () {
